...
# This version is intended to be called by another script, such as a Gazebo simulation controller.
...
# The results & robot response will print to terminal and also be returned to the calling script.
...
def run_emotion_demo(
    camera_index: int = CAMERA_INDEX,
    min_confidence: float = 0.40,
    wait_after_result: float = 2.0
) -> Dict[str, Any]:
    ...
    while True:
        ...
        if key == ord("q"):
            ...
            result_data["quit_requested"] = True
            break
            ...
            result_data = {
                "success": True,
                "emotion": latest_valid_emotion,
                "score": latest_valid_score,
                "dialogue": robot_line,
                "quit_requested": False
            }
